...
**Team**: [Your Team Name]
**Track**: ET Markets — AI for the Indian Investor
**Problem**: #6 — Chart Pattern Intelligence

### Submission Requirements
- ✅ GitHub Repository with full source code
- ✅ Architecture Document (`docs/ARCHITECTURE.md`)
- ✅ Impact Model (`docs/IMPACT_MODEL.md`)
- ⬜ 3-Minute Pitch Video (record separately)

---

## 📄 License
MIT — Built for ET Markets Hackathon 2024
